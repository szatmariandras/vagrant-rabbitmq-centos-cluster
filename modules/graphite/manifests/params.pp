...
class graphite::params {
  ...
  $graphiteVersion = '0.9.13'
  $carbonVersion   = '0.9.13'
  $whisperVersion  = '0.9.13'
  ...
  $webapp_dl_url = "https://pypi.python.org/packages/source/g/graphite-web/graphite-web-${::graphite::params::graphiteVersion}.tar.gz"
  ...
  $carbon_dl_url = "https://pypi.python.org/packages/source/c/carbon/carbon-${::graphite::params::carbonVersion}.tar.gz"
